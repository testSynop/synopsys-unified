...
export const POLARIS_ASSESSMENT_TYPES = getInput(
...
export const COVERITY_INSTALL_DIRECTORY = getInput(
  constants.COVERITY_INSTALL_DIRECTORY_KEY
);
export const COVERITY_POLICY_VIEW = getInput(
  constants.COVERITY_POLICY_VIEW_KEY
);
export const COVERITY_REPOSITORY_NAME = getInput(
  constants.COVERITY_REPOSITORY_NAME_KEY
);
export const COVERITY_BRANCH_NAME = getInput(
  constants.COVERITY_BRANCH_NAME_KEY
);
